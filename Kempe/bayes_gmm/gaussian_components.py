...
try:
    import Kempe.bayes_gmm.wishart as wishart
except:
    import wishart as wishart
...
class GaussianComponents(object):
    ...
    def restore_component_from_stats(self, k, m_N_numerator, S_N_partial, logdet_covar, inv_covar, count):
